...
function TerminalComponent(): React.ReactNode {
  ...
  const { initializeTerminal, attachTerminalFocusHandlers, resizeTerminal } = useTerminalInitialization();
  ...
  return (
    <div className={styles.terminalPage} style={{
      ...
      <TerminalConnectionWrapper connectionParams={connectionParamsForConnector}>
        {(connProps) => {
          // 确保总是有tab数组
